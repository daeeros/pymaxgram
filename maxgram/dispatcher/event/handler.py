...
from maxgram.utils.magic_filter import MagicFilter
from maxgram.utils.warnings import Recommendation
    ...
    def __post_init__(self) -> None:
        if isinstance(self.callback, OriginalMagicFilter):
            ...
            if not isinstance(self.magic, MagicFilter):
                # Issue: https://github.com/maxgram/maxgram/issues/990
                warnings.warn(
                    ...
                    "to `from maxgram import F` to silence this warning.",
                    stacklevel=6,
                )
