...
| Поле          | Тип                   | Описание                                    |
| ------------- | --------------------- | ------------------------------------------- |
| `message`     | [`Message`](#message) | Удалённое сообщение                         |
| `user_locale` | string, nullable      | Язык пользователя                           |
...
| Поле          | Тип                  | Описание                                     |
| ------------- | -------------------- | -------------------------------------------- |
| `chat_id`     | int64, nullable      | ID чата                                      |
| `user`        | [`User`](#user)      | Пользователь, запустивший бота               |
| `payload`     | string, nullable     | Deep link payload                            |
| `user_locale` | string, nullable     | Язык пользователя                            |
...
| ------------- | -------------------- | -------------------------------------------- |
| `chat_id`     | int64                | ID чата                                      |
| `user`        | [`User`](#user), nullable | Пользователь, выполнивший действие      |
| `user_id`     | int64                | ID добавленного пользователя                 |
| `inviter_id`  | int64, nullable      | ID пригласившего                              |
...
| `chat_id`     | int64                | ID чата                                      |
| `user`        | [`User`](#user), nullable | Пользователь, выполнивший действие      |
| `user_id`     | int64                | ID удалённого пользователя                   |
